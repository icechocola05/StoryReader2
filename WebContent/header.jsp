...
<body>
	<div class="header">
		<div class="w3-bar w3-border w3-card-4 w3-xlarge">
			...
			<a class="w3-bar-item w3-button w3-hover-none w3-text-black w3-hover-text-white w3-padding-24" href="#">만든 동화 보기</a>
			...
			<a class="w3-bar-item w3-button w3-hover-none w3-text-black w3-hover-text-white w3-padding-24 w3-right w3-margin-right" href="register.jsp">회원 가입</a>
	  			...
	  			<form id="f" name = "post" action = "logout">
	  				<a class="w3-bar-item w3-button w3-hover-none w3-text-black w3-hover-text-white w3-padding-24 w3-right w3-margin-right" href="mypage.jsp">마이페이지</a>
					<a class="w3-bar-item w3-button w3-hover-none w3-text-black w3-hover-text-white w3-padding-24 w3-right w3-margin-right" href="register.jsp">로그아웃</a>
	  			</form>
	  			</c:otherwise>
	  		</c:choose>
