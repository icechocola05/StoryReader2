...
/**
 * edit.jsp에서 설정한 값 가져오기
 */
@WebServlet("/DoEditVoiceEmotion")
public class DoEditVoiceEmotion extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public DoEditVoiceEmotion() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		response.setContentType("text/html; charset=UTF-8");
	      ...
	      ArrayList<Sentence> sentenceSetBefore = (ArrayList<Sentence>) session.getAttribute("sentenceSet");
	      ...
	      int sentenceSize = sentenceSetBefore.size();
	      ...
	      session.setAttribute("isSaved", 1);//1- 수정됨
